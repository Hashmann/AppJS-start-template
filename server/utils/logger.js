...
// Logger.info('TEST MESSAGE LOGGER.INFO','server.js', '127.0.0.1','DONE','v')
// Logger.info('TEST MESSAGE LOGGER.INFO','', '127.0.0.1','DOWN','x')
// Logger.info('TEST MESSAGE LOGGER.INFO','', '127.0.0.1','','v')
// Logger.info('TEST MESSAGE LOGGER.INFO','server.js', '','','x')
// Logger.info('TEST MESSAGE LOGGER.INFO','', '','','v')
//
// Logger.warning(`TEST MESSAGE LOGGER.WARNING`, 'server.js', '127.0.0.1', 'DONE')
// Logger.warning(`TEST MESSAGE LOGGER.WARNING`, '', '127.0.0.1', '')
// Logger.warning(`TEST MESSAGE LOGGER.WARNING`, 'server.js', '', 'DONE')
// Logger.warning(`TEST MESSAGE LOGGER.WARNING`, '', '', '')
//
// Logger.error('TEST MESSAGE LOGGER.ERROR', 'server.js', '127.0.0.1', 'err err err', 'ERROR')
// Logger.error('TEST MESSAGE LOGGER.ERROR', '', '127.0.0.1', 'err err err', '')
// Logger.error('TEST MESSAGE LOGGER.ERROR', 'server.js', '127.0.0.1', '', 'ERROR')
// Logger.error('TEST MESSAGE LOGGER.ERROR', '', '', '', 'ERROR')
// Logger.error('TEST MESSAGE LOGGER.ERROR', 'server.js', '', '', '')